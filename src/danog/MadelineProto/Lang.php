...
class Lang
{
  ...
  'apiChoosePrompt' => 'Your choice (m/a): ',
  'apiChooseAutomaticallyWeb' => 'خودکار',
  'apiChooseManuallyWeb' => 'دستی',
  'apiManualInstructions0' => 'Login to my.telegram.org',
  'apiManualInstructions1' => 'Go to API development tools',
  'apiManualInstructions2' => 'Click on create application',
  'apiAppInstructionsManual0' => 'your app\'s name, can be anything',
  ...
  'apiParamsError' => 'You didn\'t provide all of the required parameters!',
  'apiError' => 'ERROR: %s. Try again.',
  'loginChoosePrompt' => 'میخواهید به عنوان کاربر وارد شوید یا ربات؟ (کاربر/ربات)? ',
  'loginChoosePromptWeb' => 'میخواهید به عنوان کاربر وارد شوید یا ربات؟',
  'loginOptionBot' => 'ربات(امکان ادد زدن ندارد!)',
  'loginOptionUser' => 'کاربر',
  'loginBot' => 'توکن ربات را وارد کنید: ',
  'loginUser' => 'شماره تلفنتان را وارد کنید: ',
  'loginUserCode' => 'کد دریافتی از سمت تلگرام را وارد کنید: ',
  'loginUserPass' => 'رمز دوم اکانت خود را وارد کنید (راهنما: %s): ',
  'loginUserPassWeb' => 'رمزدوم خود را وارد کنید: ',
  'loginUserPassHint' => 'راهنما: %s',
  'signupFirstName' => 'اسم کوچکتان ر وارد کنید: ',
  'signupLastName' => 'نام خانوادگی تان را وارد کنید (میتواند خالی باشد): ',
  'signupWeb' => 'لطفا در تلگرام ثبت نام کنید',
  'signupFirstNameWeb' => 'نان',
